...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '27a4bf1cd99881e988a0d5af6abbdb45',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Aster Zephyr', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '"人不是为了幸福而活着，而是为了觉悟而活着。"', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/AsterZephyr', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog, Aster Zephyr, ads', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '"Welcome, you embodiment of freedom! Existence precedes essence; in this encounter, let us with the weight of our choices inscribe our shared story."',
